...
connection1 = mysql.connector.connect(database=database1, host=ip_addr1, port=port1, user=user_name1, password=passwd1)
connection2 = mysql.connector.connect(database=database2, host=ip_addr2, port=port2, user=user_name2, password=passwd2)
